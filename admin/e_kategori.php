...
// Cek apakahdata di temukan
if (!$data) {
    echo "<script>alert('Data tidak di temukan!); window. location.href = 'kategori.php';</script>";
    exit;
}
          ...
          <div class="card">
            <div class="card-body">
                ...
                <div class="col-12">
                  ...
                  <input type="text" class="form-control" id="nm_kategori" name="nm_kategori" placeholder="Masukan Nama Kategori" value="<?php echo $data['nm_ktg']; ?>">
                </div>

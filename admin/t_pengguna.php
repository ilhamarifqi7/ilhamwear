...
<head>
    ...
    <title>Pengguna - Ilham Wear</title>
...
<body>
                ...
                <li class="nav-item dropdown pe-3">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                        <li class="dropdown-header">
                            <h6><?php echo isset($_SESSION['username']) ? htmlspecialchars($_SESSION['username']) : 'Ilham'; ?></h6>
                            <span>Admin</span>
                        </li>
                        <li>
   ...
   <aside id="sidebar" class="sidebar">
    ...
    <footer id="footer" class="footer">
        <div class="copyright">
            &copy; Copyright <strong><span>Ilham Wear</span></strong>. All Rights Reserved
        </div>
        <div class="credits">

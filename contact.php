                					...
                					<div class="contact-info">
                						...
                						<ul class="contact-list">
                							<li>
                                                ...
                                                Jl.kebenaran ds.rt 06/ rw 07 kec.sidodadi.kab,trimakasi @2002
	                						</li>
                							<li>
                								<i class="icon-phone"></i>
                								<a href="tel:#">+082345678</a>
                							</li>
                							<li>
                								<i class="icon-envelope"></i>
                								<a href="mailto:#">info@ilhamwear.com</a>
                							</li>
                						</ul><!-- End .contact-list -->
                					...
                					<div class="contact-info">
                						...
                						<ul class="contact-list">
                							<li>
	                							...
	                							<span class="text-dark">senin-sabtu</span> <br>20.00-03.00
	                						</li>
                							<li>

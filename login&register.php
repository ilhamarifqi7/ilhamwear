...
if (isset($_POST["login"])) {
   ...
   if (mysqli_num_rows($result) === 1) {
        ...
        echo "<script>alert('Username atau pasword yang anda masukkan salah')</script>";
   }
}
?>
            		...
            		<div class="form-box">
            			<div class="form-tab">
							...
							<div class="tab-content">
							    <div class="tab-pane fade" id="signin-2" role="tabpanel" 
                                aria-labelledby="signin-tab-2">
							    	<form action="#" method="post">
							    		<div class="form-group">
							    			<label for="userlog">Username </label>
							    			<input type="text" class="form-control" id="userlog" name="userlog" 
                                            required>
							    		</div><!-- End .form-group -->
